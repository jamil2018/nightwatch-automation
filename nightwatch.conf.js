...
module.exports = {
  ...
  custom_commands_path: "src/custom_commands",

  // See https://nightwatchjs.org/guide/extending-nightwatch/#writing-custom-assertions
  custom_assertions_path: "src/custom_assertions",

  // See https://nightwatchjs.org/guide/#external-globals
  globals_path: "src/globals/default.js",
  ...
  test_settings: {
    default: {
      ...
      webdriver: {
        ...
        port: Services.chromedriverPORT ? Services.chromedriverPORT : 4444,
      },
    },
...
function loadServices() {
  ...
  try {
    ...
    Services.chromedriverPORT = 9515;
  } catch (err) {}

  try {
    Services.geckodriver = require("geckodriver");
    Services.geckodriverPORT = 4444;
  } catch (err) {}
}
